...
<script src='https://ajax.proxy.ustclug.org/ajax/libs/jquery/3.3.1/jquery.min.js'></script>
<script src='https://ajax.proxy.ustclug.org/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js'></script>
